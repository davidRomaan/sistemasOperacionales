...
//			em.crearDimensionPersona(hechoVentas.getPersona());
	 ...
	 * 
	 * @param facturaVenta
	 *            factura donde se encuentra la inforamci�n de la venta
	 * @param detalleVenta
	...
	/**
	 * Crea una dimensi�n de factura que se agregar� al hecho de venta
	 * 
	 * @param facturaVenta
	 *            factura generada
	 */
	...
	/**
	 * Crea la dimensi�n del municipio que se desea asignar al hecho de ventas
	 * 
	 * @param facturaVenta
	...
	/**
	 * Crea una dimendion del producto que se agregar� al hecho venta
	 * 
	 * @param detalleVenta
